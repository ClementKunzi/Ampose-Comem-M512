    ...
    <div class="md:mr-[15%] md:ml-[15%]">
        <div>
            <div
                ...
                :style="{
                    'background-image':
                        'url(storage/images/' + itinerary?.image.url + ')',
                }"
            ...
            <div
                ...
                :style="{
                    'background-image':
                        'url(storage/images/' + step.images[0].url + ')',
                }"
        ...
        <div class="p-4">
            <ul class="mt-[-2rem] flex gap-3">
                <li
                    v-for="tag in itinerary?.tag_categorie"
                    :key="tag.id"
                    class="bg-tv-eggshell rounded-full w-[28px] h-[28px] flex justify-center items-center"
                    aria-label="tag.taxonomy.name"
                >
                    <img
                        :src="`storage/icons/${tag.taxonomy.icon}`"
                        :alt="tag.taxonomy.description"
            ...
            <div class="flex justify-between">
                ...
                <div
                    v-if="routeItinerary"
                    class="flex items-center gap-1 text-tv-wine"
                >
            ...
            <div v-if="routeItinerary" class="flex items-center gap-2 mb-16">
                ...
                <div class="flex items-center gap-1 text-tv-wine">
                    ...
                    <p aria-label="Difficulté du parcours">
            ...
            <div
                v-if="routeItinerary"
                class="mb-16 bg-tv-wine text-tv-eggshell rounded-3xl p-8 flex justify-between"
            >
                ...
                <div class="flex flex-col items-center flex-wrap">
                    ...
                    <p>
                        <time>{{ itinerary?.estimated_time }}</time>
                    </p>
                </div>
            ...
            <div class="mb-16">
                ...
                <div :class="{ 'map-step': !routeItinerary }">
                    <div
                        id="map"
                        class="map-pageLayout map-noUi map-noSearch"
                    ></div>
                </div>
            </div>
            <div v-if="routeItinerary" class="text-tv-wine">
                ...
                <ul class="flex flex-col gap-3">
                    <li
                        v-for="tag in itinerary?.tag_accessibility"
                        :key="tag.id"
            ...
            <div v-if="routeItinerary" class="mb-16 justify-center">
                <button @click="downloadPdf(itineraire)" class="btn">
            ...
            <div v-if="routeItinerary">
                <h3 class="text-tv-wine">
                    Avis de la communauté <span>(8)</span>
                </h3>
                <div class="flex items-center gap-1 text-tv-wine">
                    <Star stroke="#754043" :size="18" />
                    <p aria-label="Note du parcours sur 5">4.8</p>
                ...
                <div>
                    <div
                        class="border-t border-solid border-tv-wine py-4"
                        v-for="i in 3"
                        :key="i"
                    >
                        <div class="mb-4 flex gap-4">
                            <div class="w-11 h-11">
                                <img
                                    class="rounded-full"
                                    src="https://loremflickr.com/88/88"
                                    alt=""
                                />
                            </div>
                            <div>
                                ...
                                <div
                                    class="flex items-center gap-1"
                                    aria-label="Note de l'utilisateur: 5 étoiles sur 5"
                                >
                                    <Star
                                        aria-hidden="true"
                                        stroke="#754043"
                        ...
                        <p class="mb-4">
                            Pizza très bonne, je recommande Pizza très bonne, je
                            recommande sdf kjbs dfksdj nf 👍
                        </p>
                        <p class="text-right">
                            <time aria-label="">11.11.2023</time>
                        </p>
                    </div>
